...
// Same note card as Stage 4's (teknik-aseptik/SuccessNote.tsx) - see there for
// the anchoring rationale. Every procedure on this stage ends this way, so
// the shell owns it and no procedure renders one.
