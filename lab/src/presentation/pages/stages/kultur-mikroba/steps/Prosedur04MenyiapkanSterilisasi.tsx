...
// Prosedur 4 - "Menyiapkan Media untuk Sterilisasi" (Figma frames
// "5.4 - A/B/C/D"). Pour the media into the Erlenmeyer, plug it with cotton
// wool, then wrap the mouth in foil - a straight three-click chain, the same
// shape as Stage 4's own hand-wash procedure: click the right object next and
// the art cuts to the next plate.
//
...
// Langkah 4's card (244 design px) sits between Langkah 1/2's (247) and
// Langkah 3's (230): its instruction text wraps to three lines like
// Langkah 1/2's, but its own hint paragraph is one line shorter.
...
// rising, or the Analyst reads "Media siap disterilisasi!" over a flask that
// still looks unwrapped.
const SETTLE_MS = 460;

export function Prosedur04MenyiapkanSterilisasi({ step, runtime }: ProcedureProps<AssembleStep>) {
...
// Same floating card shape as Prosedur 1/2/3's own (Figma group "LANGKAH 6"):
