...
import { TOTAL_STEPS } from '../../../../data/stages/pengelolaanLimbah';
import type { ProcedureStep } from '../../../../data/stages/pengelolaanLimbah';

// Same tracking card as Stage 2's (kultur-mikroba/ProcedureCard.tsx) and
// Stage 4's (teknik-aseptik/ProcedureCard.tsx) - see there for the full
// derivation of every measurement below, none of which changed for this
// stage's frame - except the card's own x/y, which Langkah 4's frame moves
// to the right (Figma group 313:1960: x=1356.096, y=471.96) to leave the
// left side of the bench free for its three sorting bins. Every other
// Langkah keeps the original left-side position, passed as the default.
const PROCEDURE_CARD_DEFAULT_POSITION = { x: 49.917, y: 219.623 };
const PROCEDURE_CARD = { width: 506.572, bannerHeight: 425.848 };
...
export function ProcedureCard({
  ...
  showDots,
  animation,
  position = PROCEDURE_CARD_DEFAULT_POSITION,
}: {
  step: ProcedureStep;
  showDots: boolean;
  animation: Animation;
