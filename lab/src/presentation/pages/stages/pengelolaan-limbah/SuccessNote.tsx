...
// Same note card as Stage 2's (kultur-mikroba/SuccessNote.tsx) and Stage 4's
// (teknik-aseptik/SuccessNote.tsx) - see there for the anchoring rationale.
// Every procedure on this stage ends this way, so the shell owns it and no
// procedure renders one.
